...
# For Reviewers
Unity creates thousands of metadata files ad directories that can make reviewing the code a hassle. Most of the code in this repository was generated by Unity, not created by our team. To navigate to the directory where the scripts we created are located, follow this link: [https://github.com/MCommins/VR-Construction-Training-System/tree/develop/VR-CTS/Assets/Scripts]
